...
<form method="get" action="http://staging.websrch.cit.nih.gov/sps/Smokefree_60Plus/Results.html?query=test" name="search" id="search-block-form">
 <label for="search-block-form" class="element-invisible">Search Smokefree 60 Plus</label>
               <input title="Enter the term(s) you wish to search." placeholder="Search" class="form-control form-text" type="text" id="edit-search-block-form--2" name="q" value="" size="15" maxlength="128">
               
        <input type="hidden" name="site" value="SMOKEFREE_60PLUS"/>
        <input type="hidden" name="client" value="SMOKEFREE_60PLUS_frontend"/>
        <input type="hidden" name="proxystylesheet" value="SMOKEFREE_60PLUS_frontend"/>
